class Claim:
    ...
    def set_claim_id(self, claim_id): self.__claim_id = claim_id

    def get_claim_number(self): return self.__claim_number
    def set_claim_number(self, claim_number): self.__claim_number = claim_number

    def get_date_filed(self): return self.__date_filed
    def set_date_filed(self, date): self.__date_filed = date

    def get_claim_amount(self): return self.__claim_amount
    def set_claim_amount(self, amount): self.__claim_amount = amount
    ...
    def __str__(self):
        return f"Claim [ID={self.__claim_id}, Number={self.__claim_number}, Amount={self.__claim_amount}, Status={self.__status}]"
